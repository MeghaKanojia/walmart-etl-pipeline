...
|---|---|---|---|
| `grocery_sales` | SQL table — Store ID, Date, Dept, Weekly Sales | 231,522 | ✅ (via DataCamp environment) |
...
> The raw grocery_sales data is sourced from Walmart's publicly referenced sales dataset, provided via the DataCamp project environment.
...
> ```python
> import pandas as pd
> grocery_sales = pd.read_csv('grocery_sales.csv')  # if you have the raw CSV
> ```
